...
export function CompletudeSection({ compliance }: CompletudeSectionProps) {
  ...
  return (
    <Card className="border border-stone-200 dark:border-stone-800 shadow-xs">
      ...
      <CardContent className="pb-4 pt-3 space-y-3 text-xs">

        {/* ── Résumé ────────────────────────────────────────────────── */}
        <div className="grid grid-cols-3 gap-2">
          <div className="flex flex-col items-center gap-1 p-2 rounded-md bg-emerald-50/70 dark:bg-emerald-950/30 border border-emerald-200/60 dark:border-emerald-900/40 text-center">
          ...
          <div className="flex flex-col items-center gap-1 p-2 rounded-md bg-rose-50/70 dark:bg-rose-950/30 border border-rose-200/60 dark:border-rose-900/40 text-center">
          ...
          <div className="flex flex-col items-center gap-1 p-2 rounded-md bg-amber-50/70 dark:bg-amber-950/30 border border-amber-200/60 dark:border-amber-900/40 text-center">
